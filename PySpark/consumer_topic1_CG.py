...
# 2. Price Range: Calculate price range (High - Low)
...
df_flattened = df_flattened.withColumn("Price_Category", when(col("Close") < 150, "Low")
                                       .when(col("Close").between(150, 300), "Medium")
                                       .otherwise("High"))
